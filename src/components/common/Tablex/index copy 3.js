import React, {useContext, useRef, useState, useEffect, Children} from "react";
...
const EditableRow = (row) => {
  ...
  //   childNode += <div>{ rowData[data] }</div>
  // }
  let child = EditableCell(rowProps.children)
  console.log(child)
  return (
    <Form form={form} component={false} >
      <EditableContext.Provider value={form}>
        <div className={rowProps.className} style={rowProps.style}>{ rowProps.children }</div>
