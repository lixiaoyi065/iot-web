...
class ReactVirtualSizeTable extends Component {
	...
	render() {
		...
		return <div className="react-virtual-size-table" onScroll={this.onScroll} style={{width: '100vw', height, overflow: "scroll"}} >
			<div className="react-virtual-size-container" style={{width: "100vw", height: totalHeight, position: "relative"}} >
				{this.renderCell()}
			</div>
		</div>;
	}
